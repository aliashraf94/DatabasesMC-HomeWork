...
select * from customers c where c.country = 'United States';
...
select s2.supplier_name, p2.product_name, p2.unit_price from suppliers s2
inner join products p2 on p2.supplier_id = s2.id
...
inner join order_items oi on order_id = o.id
